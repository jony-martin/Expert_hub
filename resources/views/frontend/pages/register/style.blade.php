...
.steps {
    width: 700px;
    margin: 0 auto; /* Removed top margin to eliminate gap */
    position: relative;
    overflow: hidden;
    height: 550px;
    background: #ffffff;
    border-radius: 0 0 12px 12px; /* Removed top border-radius for seamless connection */
...
@media (max-width: 675px) {
    .steps {
        width: 95%;
        margin: 0 auto; /* Removed top margin on mobile too */
        height: auto;
        min-height: 700px;
        padding: 20px;
        margin-bottom: 30px;
...
@media (max-width: 675px) {
    .info {
        ...
        /* Smaller radius */
        animation: fadeInSlideDown 0.8s ease-out; /* Faster animation on mobile */
    }
    ...
    .info h1 {
        ...
        letter-spacing: 1px;
        /* Reduced spacing */
        animation: fadeInText 1s ease-out 0.2s forwards; /* Adjusted delay */
    }
}
