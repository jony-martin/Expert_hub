                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                ...
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend') }}/assets/images/product-image/3_4.jpg"
                                        alt="" />
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{ asset('frontend') }}/assets/images/product-image/3_5.jpg"
                                        alt="" />
                                </div>
                            </div>
