                ...
                <div class="ec-sidebar-block">
                        ...
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/dress-8.png" class="svg_img" alt="drink" />Cothes
                                </div>
                                <ul style="display: block">
                                    <li>
                                        <div class="ec-sidebar-sub-item">
                                            <a href="shop-left-sidebar-col-3.html">Shirt <span title="Available Stock">-
                                                    25</span></a>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="ec-sidebar-sub-item">
                                            <a href="shop-left-sidebar-col-3.html">jacket<span title="Available Stock">-
                                                    500</span></a>
                                        </div>
                                    </li>
                                    <li>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/shoes-8.png" class="svg_img" alt="drink" />Footwear
                                </div>
                                <ul>
                                    <li>
                                        <div class="ec-sidebar-sub-item">
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/jewelry-8.png" class="svg_img"
                                        alt="drink" />jewelry
                                </div>
                                <ul>
                                    <li>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/perfume-8.png" class="svg_img"
                                        alt="drink" />perfume
                                </div>
                                <ul>
                                    <li>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/cosmetics-8.png" class="svg_img"
                                        alt="drink" />cosmetics
                                </div>
                                <ul>
                                    <li>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/glasses-8.png" class="svg_img"
                                        alt="drink" />glasses
                                </div>
                                <ul>
                                    <li>
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item">
                                    <img src="{{ asset('frontend') }}/assets/images/icons/bag-8.png" class="svg_img" alt="drink" />bags
                                </div>
                                <ul>
                                    <li>
                                        <div class="ec-sidebar-sub-item">
