                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="small mb-1">Congratulation Lettie ð</h6>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1 small">New Message âï¸</h6>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item mt-0" href="{{ route('profile.edit', auth()->id()) }}">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('profile.edit', auth()->id()) }}"> <i
