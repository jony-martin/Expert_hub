                                ...
                                <div class="row mb-6">
                                    <div class="col-12 col-md-6">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" class="form-control" id="name"
                                                placeholder="Enter full name" value="{{ old('name') }}" name="name"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="mb-6">
                                            ...
                                            <input type="tel" class="form-control" id="phone"
                                                placeholder="0123-4567" value="{{ old('phone') }}" name="phone"
                                                aria-label="Phone" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 mb-6">
                                        <label class="form-label" for="address">Address<span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control" id="address" name="address" rows="2" placeholder="Address">{{ old('address') }}</textarea>
                                    </div>
